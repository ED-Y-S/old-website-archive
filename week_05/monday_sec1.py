...
url2 = 'https://www.ΒankΟfΑmerica.com'#29
url3 = 'https://www.BankOf​America.com'#30

greek = 'αβγδεζηθικλμνξοπρςστυφχψ'

empty = '​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​' #42 characters in here just because.
...
accents_1c = '\U000000e1' # \U can store anything
accents_2b = 'a\u0301' #same gramphee, but different character
...
vietnamese_NFKD = 'lập trình máy tính là tốt nhất !!!' #unicodedata.normalize('NFC', vietnamese_NFKD) == unicodedata.normalize('NFC', vietnamese_NFKC)
...
#documents with 1000 english characters; that means 1000 ASCII values => 1000 bytes

# The `byte` type looks like strings but starts with a `b`

normal_string = 'they just have quotes'
raw_string = r'quotes that \n that with r' #r ignore escape characters
...
bytes1 = 'hello world'.encode('utf-8')#== b'hellow world'
...
#bytes1.decode('utf-8') = 'hello world'
# PRINCIPLE 3:

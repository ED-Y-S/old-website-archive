...
#submission.comments.replace_more(limit=None) clicks all of the "more comments" so you get all of them
...
#submission.comments[0].replies[1].replies[0].author to see the author
